...
public class Lavadora {
    ...
    //setter y getter del tipo de ropa
    ...
    private void Llenado() {//este metodo sirve para verificar el llenado
        if (Kilos <= 12 && Kilos>=0) {
            ...
            System.out.println("La lavadora esta fallando el peso no coincide");
        }
        else {
    ...
    private void Secado(){//este metodo sirve para proceder al secado
        Lavado();
        if(LavadoCompleto==1){
